 ...
 * a LED off we need to drive the pin connec * Pulling it low will turn it on.
ted to it high.
 */
 ...
 * bubble address
 */
static uint8_t bubble_address = BUBBLE_ADDRESS;
/* 
 * bubble address
 */
...
const routine_item_t* routine_array[num_of_bubble_classes] = {
          ...
          //  mentor_bubble_routine,
            ...
            start_bubble_routine,
            error_routine
        };
*/
/*
routine_item_t* routine_array[] = {
            initialize_bubble_routine,
            idle_bubble_routine,
            paired_bubble_routine,
            mentor_bubble_routine,
            red_group_bubble_routine,
            orange_group_bubble_routine,
            yellow_group_bubble_routine,        
            purple_group_bubble_routine,
            flashback_routine
        };
 * */
/* 
 ...
 */
//routine_item_t* current_routine_array = initialize_bubble_routine;
...
bubble_class_t detect_bubble_class(uint8_t address){
    ...
    else if(address < STUDENT_ADDRESS_RANGE_RED){
 ...
 */
 ...
 void perform_action(routine_item_t* item){
    ...
    if(item->action_duration_ms >10000){
        delay_time = 1000;
    }
    else{
  ...
  /* 
   void excute_next_routine_item(routine_item_t* items){
     ...
     */
 /*
void change_routine_array(routine_names_t routine_names){
    // reset routine array indeces 
    current_index = -1;
    current_num_of_repeats = 0;
    // load new routine array
    current_routine_array = routine_array[routine_names];      
}
*/
 /*
